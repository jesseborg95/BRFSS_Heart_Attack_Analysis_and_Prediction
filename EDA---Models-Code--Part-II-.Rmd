...
```{r}
#bal_hrt_attack_training <- subset(bal_hrt_attack_training, select = -c(weight, state))
randForest.heart_attack = randomForest(heart_attack~., data=bal_hrt_attack_training, mtry=5, importance= TRUE)
...
According to the Hosmer and Lemeshow Goodness of Fit test using the training dataset, the p value is `r heart_attackHoslem$p.value`. This is very small so it means that this model is a good fit.  
