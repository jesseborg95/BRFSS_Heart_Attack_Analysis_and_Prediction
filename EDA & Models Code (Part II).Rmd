...
According to the Hosmer and Lemeshow Goodness of Fit test using the training dataset, the p value is `r admitLogitHoslem$p.value`. This is very small so it means that this model is a good fit. Although this test is not very meaningful for models with only factors, it continues to support the other analysis. 
